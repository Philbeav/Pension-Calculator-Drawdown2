...
# --- REWRITTEN INTERACTIVE SLIDERS ---

# Current Pot Slider
current_pot = st.slider(
    "Current Private Pension Pot (£)", 
    min_value=0, 
    max_value=3500000, 
    value=500000, 
    step=5000,
    format="£%d" # This adds commas automatically in many browsers
)
...
# Monthly Drawdown Slider
monthly_drawdown_goal = st.slider(
...
fixed_monthly_withdrawal = float(monthly_drawdown_goal)
